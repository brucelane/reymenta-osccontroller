...
/// Cette référence permet de manipuler le frame et de garantir que les requêtes de navigation 
/// de clavier ont lieu uniquement lorsque la page occupe toute la fenêtre.</param>
...
#else
/// <summary>
/// Appelé à chaque séquence de touches, notamment les touches système comme les combinaisons utilisant la touche Alt, lorsque
/// cette page est active et occupe la totalité de la fenêtre.  Utilisé pour détecter la navigation à l'aide du clavier
/// parmi les pages, même lorsque la page elle-même n'a pas le focus.
/// </summary>
/// <param name="sender">Instance qui a déclenché l'événement.</param>
/// <param name="e">Données d'événement décrivant les conditions ayant déclenché l'événement.</param>
	...
	AcceleratorKeyEventArgs^ e)
{
	...
	// Approfondit les recherches uniquement lorsque les touches Gauche, Droite ou les touches Précédente et Suivante dédiées
	// sont actionnées
		...
		virtualKey == VirtualKey::GoBack || virtualKey == VirtualKey::GoForward))
	{
		...
		{
			// Lorsque la touche Précédente ou les touches Alt+Gauche sont actionnées, navigue vers l'arrière
			e->Handled = true;
		...
		{
			// Lorsque la touche Suivante ou les touches Alt+Droite sont actionnées, navigue vers l'avant
			e->Handled = true;
...
/// <summary>
/// Appelé sur chaque clic de souris, pression d'écran tactile ou interaction équivalente lorsque cette
/// page est active et occupe la totalité de la fenêtre.  Utilisé pour détecter les clics de souris Suivante et Précédente
/// de style navigateur pour naviguer parmi les pages.
/// </summary>
/// <param name="sender">Instance qui a déclenché l'événement.</param>
/// <param name="e">Données d'événement décrivant les conditions ayant déclenché l'événement.</param>
void NavigationHelper::CoreWindow_PointerPressed(CoreWindow^ sender, PointerEventArgs^ e)
{
	...
	// Si les boutons Précédente ou Suivante sont utilisés (mais pas les deux à la fois) navigue en conséquence
...
/// <summary>
/// Appelé lorsque cette page n'est plus affichée dans un frame.
/// </summary>
/// <param name="e">Données d'événement décrivant la manière dont l'utilisateur a accédé à cette page.  La propriété Parameter
/// fournit le groupe devant être affiché.</param>
