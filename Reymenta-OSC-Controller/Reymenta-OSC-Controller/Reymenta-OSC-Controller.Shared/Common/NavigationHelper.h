...
namespace Reymenta_OSC_Controller
{
	namespace Common
	{
		...
		///		constructeur de la page et inscrire un rappel pour les événements 
		///		LoadState et SaveState.
		/// <code>
		///		MyPage::MyPage()
		///		{
		///			InitializeComponent();
		...
		public:
			/// <summary>
			/// <see cref="RelayCommand"/> utilisée pour la liaison à la propriété Command du bouton Précédente
			...
			/// <summary>
			/// <see cref="RelayCommand"/> utilisée pour accéder à l'élément le plus récent de 
